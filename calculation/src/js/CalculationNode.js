// <<MODEL>> There are some different as Nodejs needs module.exports to run the function and it is not supported in original JS(Uncaught ReferenceError: module is not defined)
